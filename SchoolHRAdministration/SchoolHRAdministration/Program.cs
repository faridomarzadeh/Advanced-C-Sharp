...
public class Program
{
    static void Main(string[] args)
    {
        ...
        //Console.WriteLine($"Total Annual Salary (Including bonus) : {totalSalary}");

        Console.WriteLine($"Total Annual Salary (Including bonus) : {employees.Sum(e => e.Salary)}");
    }
