...
namespace ThermostatEventsApp
{
    ...
    public class Thermostat : IThermostat
    {
        ...
        private void HeatSensor_TemperatureReachesEmergencyLevelEventHandler(object? sender, TemperatureEventArgs e)
        {
            ...
            Console.WriteLine();
            Console.WriteLine($"Emergency Alert!! Temperature exceeds emergency level (emergency level is above {_heatSensor.EmergencyLevel})");
        ...
        private void HeatSensor_TemperatureReachesWarningLevelEventHandler(object? sender, TemperatureEventArgs e)
        {
            ...
            Console.WriteLine();
            Console.WriteLine($"warning Alert!! Temperature reached warning level (Warning level is between {_heatSensor.WarningLevel} and {_heatSensor.EmergencyLevel})");
        ...
        private void HeatSensor_TemperatureFallsBelowWarningLevelEventHandler(object? sender, TemperatureEventArgs e)
        {
            ...
            Console.WriteLine();
            Console.WriteLine($"Informatiob Alert!! Temperature falls below warning level (Warning level is between {_heatSensor.WarningLevel} and {_heatSensor.EmergencyLevel})");
            _coolingMechanism.On();
            Console.ResetColor();
        }
    ...
    public class HeatSensor : IHeatSensor
    {
        ...
        public double WarningLevel { get { return _warningLevel; } }
        public double EmergencyLevel { get { return _emergencyLevel; } }
        ...
        event EventHandler<TemperatureEventArgs> IHeatSensor.TemperatureReachesEmergencyLevelEventHandler   //emergency
        {
            add
            {
        ...
        event EventHandler<TemperatureEventArgs> IHeatSensor.TemperatureReachesWarningLevelEventHandler     //warning
        {
            add
            {
        ...
        event EventHandler<TemperatureEventArgs> IHeatSensor.TemperatureFallsBelowWarningLevelEventHandler      //Below
        {
            add
            {
